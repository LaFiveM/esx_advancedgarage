...
Config.CarPoundPrice      = 250 -- Car Pound Price.

Config.BoatPoundPrice     = 250 -- Boat Pound Price.

Config.AircraftPoundPrice = 250 -- Aircraft Pound Price.



Config.PolicingPoundPrice  = 0 -- Policing Pound Price.

Config.TaxingPoundPrice  = 100 -- Policing Pound Price.

Config.SherifingPoundPrice  = 0 -- Policing Pound Price.
...
Config.CarGarages = {
	...
	Garage_CentralLS = {
		...
		GaragePoint = { x = 215.800, y = -810.057, z = 29.78 },
		...
		DeletePoint = { x = 223.797, y = -760.415, z = 29.78 },



		PreviewCar = { x = 237.31, y = -814.27, z = 29.38, h = 158.47 },
	...
	Garage_Sandy = {
		...
		PreviewCar = { x = 1750.62, y = 3715.01, z = 34.11, h = 26.51 },
	...
	Garage_Paleto = {
		...
		GaragePoint = { x = 107.26, y = 6611.91, z = 30.98 },



		SpawnPoint = { x = 115.71, y = 6599.87, z = 31.57, h = 271.98 },
		...
		PreviewCar = { x = 127.52, y = 6623.35, z = 31.37, h = 169.11 },
	...
	Garage_Prison = {
		...
		GaragePoint = { x = 1850.9, y = 2584.47, z = 44.69 },



		SpawnPoint = { x = 1855.65, y = 2578.95, z = 45.38, h = 270.79 },



		DeletePoint = { x = 1855.21, y = 2615.3, z = 44.67 }, -- z = 44.67



		PreviewCar = { x = 1856.71, y = 2593.14, z = 45.67, h = 274.33 },
	...
	Garage_VinewoodBoulevard = {
		...
		GaragePoint = { x = 640.69, y = 205.73, z = 96.29 },



		SpawnPoint = { x = 641.18, y = 195.58, z = 95.92, h = 338.5 },



		DeletePoint =  { x = 656.85, y = 197.96, z = 94.33 },



		PreviewCar = { x = 633.8, y = 198.72, z = 96.63, h = 247.77 },
	...
	Vespucci_Beach = {
		...
		GaragePoint = { x = -1186.720, y = -1506.341, z = 3.40 },



		SpawnPoint = { x = -1200.01, y = -1482.665, z = 3.37, h = 215.0 },



		DeletePoint = { x = -1201.823, y = -1488.213, z = 3.37},



		PreviewCar = { x = -1193.57, y = -1499.5, z = 4.38, h = 305.15 },
	...
	BAYWATHC = {
		...
		GaragePoint = { x = -753.85, y = -1511.62, z = 4.03 },



		SpawnPoint = { x = -737.36, y = -1499.35, z = 4.02, h = 24.03 },



		DeletePoint = { x = -742.47, y = -1506.26, z = 4.02},



		PreviewCar = { x = -749.0, y = -1502.57, z = 4.58, h = 333.23 },
	...
	Mhospital = {
		...
		GaragePoint = { x = -825.94, y = -433.54, z = 35.80 },



		SpawnPoint = { x = -822.65, y = -438.23, z = 36.64, h = 115.85 },



		DeletePoint = { x = -830.57, y = -452.26, z = 35.64},



		PreviewCar = { x = -822.65, y = -438.23, z = 36.64, h = 115.85 },
	...
	Grove = {
		...
		GaragePoint = { x = 345.41, y = -1682.48, z = 26.3 },



		SpawnPoint = { x = 345.16, y = -1691.77, z = 26.3, h = 319.07 },



		DeletePoint = { x = 361.23, y = -1686.08, z = 26.3},



		PreviewCar = { x = 345.16, y = -1691.77, z = 27.3, h = 319.07 },
	...
	Farm = {
		...
		GaragePoint = { x = 2557.65, y = 4672.48, z = 33.06 },



		SpawnPoint = { x = 2552.75, y = 4677.12, z = 33.92, h = 17.43 },



		DeletePoint = { x = 2553.16, y = 4671.13, z = 32.95},



		PreviewCar = { x = 2552.75, y = 4677.12, z = 33.92, h = 17.43 },
	...
	pd = {
		...
		GaragePoint = { x = -1160.86, y = -741.48, z = 18.63 },



		SpawnPoint = { x = -1186.78, y = -742.87, z = 19.28, h = 306.88 },



		DeletePoint = { x = -1184.57, y = -729.99, z = 19.63},



		PreviewCar = { x = -1186.78, y = -742.87, z = 19.28, h = 306.88 },
	...
	Repter = {
		...
		GaragePoint = { x = -1279.24, y = -3347.28, z = 12.95 },



		SpawnPoint = { x = -1251.93, y = -3341.15, z = 12.95, h = 332.75 },



		DeletePoint = { x = -1251.93, y = -3341.15, z = 12.95},



		PreviewCar = { x = 1251.93, y = -3341.15, z = 12.95, h = 332.75 },
...
Config.CarPounds = {
	...
	Pound_repter = {
		...
		PoundPoint = { x = -1284.07, y = -3419.35, z = 12.94 },

		SpawnPoint = { x = -1279.65, y = -3394.86, z = 13.94, h = 325.58 }
